...
# Checking file existance, backup and file operation
if os.path.isfile("%s" % outputFile):
    os.rename(outputFile,outputFile+"-bk")
...
# Json Validation and Output the json for terraform
try:
   Json_data =  json.dumps({"filename":outputFile})
